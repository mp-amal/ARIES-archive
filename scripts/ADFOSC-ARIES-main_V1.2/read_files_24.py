...
main_dir = '/home/adfosctest/HEADER_updatation/2023-C1/'
log_header_dir = os.path.join(main_dir,"LOG_header_update")
os.makedirs(log_header_dir,exist_ok=True)
f = glob.glob(os.path.join(main_dir+'2023_02_0*'))

for fdate in f:
    foldername = os.path.basename(fdate)
    log_file = os.path.join(log_header_dir,f'headerupdated_files_{foldername}+_06012025.txt')
    err_log_file = os.path.join(log_header_dir,f'error_headerupdated_files_{foldername}+_06012025.txt')
