...
output_file = paths_yaml['DIR_DOC']+"ST_Process_folders.dat"
...
def datedisplay(source_directory, Base_folder, output_file,ydatefolder):
    ...
    os.makedirs(os.path.join(paths_yaml['final'],cycle,'Polarimetry'),exist_ok= True)
    polarimetry_list = sort_date(os.path.join(paths_yaml['final'],cycle,'Polarimetry'))
    ...
    with open(output_file, 'w') as f:
        ...
        for folder_name in folders_to_copy:
            ...
            desitnation_folder = os.path.join(paths_yaml['final'],cycle, 'Polarimetry',folder_name)
...
# server_ip = "172.18.1.5"  # Replace with your server's IP
# username = "teldatauser"    # Replace with your username
# password = "Iv4[<43W"    # Replace with your password


source_directory =os.path.join(paths_yaml['ST_source_directory'],cycle,'rawdata')
os.makedirs(os.path.join(paths_yaml['ST_source_directory'],cycle,'rawdata'),exist_ok=True)
Base_folder =os.path.join(paths_yaml['ST_Base_folder'],cycle,'Processed_data')
os.makedirs(os.path.join(paths_yaml['ST_Base_folder'],cycle,'Processed_data'),exist_ok=True)
def main():
    ...
    process_folders =paths_yaml['DIR_DOC']+'ST_Process_folders.dat'
